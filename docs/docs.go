                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateHomeRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpdateShoppingCategoryRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.AssignUserRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/homes/{home_id}/tasks/{task_id}/reassign-room": {
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Reassign Room Request",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.ReassignRoomRequest"
                        }
                    }
                ],
                "responses": {
